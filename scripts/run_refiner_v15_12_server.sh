...
TAG="refiner_v15_12_group_rms_${STAMP}"
mkdir -p outputs logs
LOG="logs/refiner_v15_12_${STAMP}.log"
STATUS="outputs/refiner_v15_12_${STAMP}.exit_status.txt"
printf '%s\n' "$TAG" > outputs/LATEST_REFINER_V15_12_TAG
printf '%s\n' "$LOG" > outputs/LATEST_REFINER_V15_12_LOG
printf '%s\n' "$STATUS" > outputs/LATEST_REFINER_V15_12_STATUS
