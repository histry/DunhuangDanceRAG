...
TAG="refiner_v15_9_long_temporal_${STAMP}"
mkdir -p outputs logs
LOG="logs/refiner_v15_9_${STAMP}.log"
STATUS="outputs/refiner_v15_9_${STAMP}.exit_status.txt"
printf '%s\n' "$TAG" > outputs/LATEST_REFINER_V15_9_TAG
printf '%s\n' "$LOG" > outputs/LATEST_REFINER_V15_9_LOG
printf '%s\n' "$STATUS" > outputs/LATEST_REFINER_V15_9_STATUS
