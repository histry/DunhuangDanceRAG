...
TAG="refiner_v15_10_slack_guard_${STAMP}"
mkdir -p outputs logs
LOG="logs/refiner_v15_10_${STAMP}.log"
STATUS="outputs/refiner_v15_10_${STAMP}.exit_status.txt"
printf '%s\n' "$TAG" > outputs/LATEST_REFINER_V15_10_TAG
printf '%s\n' "$LOG" > outputs/LATEST_REFINER_V15_10_LOG
printf '%s\n' "$STATUS" > outputs/LATEST_REFINER_V15_10_STATUS
