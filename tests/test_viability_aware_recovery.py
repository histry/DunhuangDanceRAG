...
def test_nonterminal_but_viable_hard_safe_candidate_can_recover(monkeypatch):
    ...
    monkeypatch.setenv("ROUTING_BUDGET_RECOVERY_BUDGET_TOTAL", "3.0")
    monkeypatch.setenv("ROUTING_BUDGET_RECOVERY_MINIMUM_VIABILITY_DEPTH", "2")
    monkeypatch.setenv("ROUTING_BUDGET_RECOVERY_TOPK", "1")
